...
let levels = {
    ...
    15: [
        { x: 0, y: 750, width: 1400, height: 50 }, // Підлога
        { x: 150, y: 600, width: 100, height: 20 }, // Перша платформа
        { x: 350, y: 500, width: 100, height: 20 }, // Друга платформа
        { x: 550, y: 400, width: 100, height: 20 }, // Третя платформа
        { x: 750, y: 500, width: 100, height: 20 }, // Четверта платформа
        { x: 950, y: 600, width: 100, height: 20 }, // П'ята платформа
        { x: 1150, y: 500, width: 150, height: 20 }, // Фінальна платформа
        { x: 0, y: 300, width: 1400, height: 20 } // Стеля з шипами
    ],
    16: [
        { x: 0, y: 750, width: 1400, height: 50 }, // Підлога
        { x: 200, y: 650, width: 150, height: 20 }, // Перший щабель
        { x: 400, y: 550, width: 50, height: 20 }, // Вузька платформа
        { x: 600, y: 450, width: 150, height: 20 }, // Третій щабель
        { x: 800, y: 350, width: 50, height: 20 }, // Вузька платформа
        { x: 1000, y: 250, width: 150, height: 20 }, // П'ятий щабель
        { x: 1200, y: 150, width: 150, height: 20 } // Фінальна платформа
    ],
    17: [
        { x: 0, y: 750, width: 1400, height: 50 }, // Підлога
        { x: 100, y: 650, width: 50, height: 20 }, // Вузька платформа
        { x: 300, y: 550, width: 50, height: 20 }, // Вузька платформа
        { x: 500, y: 450, width: 50, height: 20 }, // Вузька платформа
        { x: 700, y: 350, width: 50, height: 20 }, // Вузька платформа
        { x: 900, y: 250, width: 50, height: 20 }, // Вузька платформа
        { x: 1100, y: 150, width: 150, height: 20 }, // Фінальна платформа
        { x: 0, y: 400, width: 1400, height: 20 } // Стеля з шипами
    ]
...
let finishlevel = {
    ...
    15: [
        { x: 1350, y: 350, width: 20, height: 150 } // Фініш у верхній частині
    ],
    16: [
        { x: 1350, y: 0, width: 20, height: 150 } // Фініш у верхньому правому куті
    ],
    17: [
        { x: 1350, y: 0, width: 20, height: 150 } // Фініш у верхньому правому куті
    ]
...
let shiplevel = {
    ...
    15: [
        { x: 250, y: 725 }, { x: 275, y: 725 }, // Шипи на підлозі між 1-ю і 2-ю платформами
        { x: 450, y: 725 }, { x: 475, y: 725 }, // Шипи на підлозі між 2-ю і 3-ю платформами
        { x: 650, y: 725 }, { x: 675, y: 725 }, // Шипи на підлозі між 3-ю і 4-ю платформами
        { x: 850, y: 725 }, { x: 875, y: 725 }, // Шипи на підлозі між 4-ю і 5-ю платформами
        { x: 1050, y: 725 }, { x: 1075, y: 725 }, // Шипи на підлозі перед фінальною платформою
        { x: 300, y: 320, upsideDown: true }, { x: 325, y: 320, upsideDown: true }, // Шипи на стелі
        { x: 600, y: 320, upsideDown: true }, { x: 625, y: 320, upsideDown: true }, // Шипи на стелі
        { x: 900, y: 320, upsideDown: true }, { x: 925, y: 320, upsideDown: true } // Шипи на стелі
    ],
    16: [
        { x: 350, y: 725 }, { x: 375, y: 725 }, // Шипи на підлозі
        { x: 450, y: 625 }, { x: 475, y: 625 }, // Шипи між 1-ю і 2-ю платформами
        { x: 550, y: 525 }, { x: 575, y: 525 }, // Шипи між 2-ю і 3-ю платформами
        { x: 750, y: 425 }, { x: 775, y: 425 }, // Шипи між 3-ю і 4-ю платформами
        { x: 950, y: 325 }, { x: 975, y: 325 }, // Шипи між 4-ю і 5-ю платформами
        { x: 1150, y: 225 }, { x: 1175, y: 225 } // Шипи перед фінальною платформою
    ],
    17: [
        { x: 150, y: 725 }, { x: 175, y: 725 }, { x: 200, y: 725 }, // Шипи на підлозі
        { x: 350, y: 625 }, { x: 375, y: 625 }, // Шипи між 1-ю і 2-ю платформами
        { x: 550, y: 525 }, { x: 575, y: 525 }, // Шипи між 2-ю і 3-ю платформами
        { x: 750, y: 425 }, { x: 775, y: 425 }, // Шипи між 3-ю і 4-ю платформами
        { x: 950, y: 325 }, { x: 975, y: 325 }, // Шипи між 4-ю і 5-ю платформами
        { x: 1050, y: 225 }, { x: 1075, y: 225 }, // Шипи перед фінальною платформою
        { x: 200, y: 420, upsideDown: true }, { x: 225, y: 420, upsideDown: true }, // Шипи на стелі
        { x: 400, y: 420, upsideDown: true }, { x: 425, y: 420, upsideDown: true }, // Шипи на стелі
        { x: 600, y: 420, upsideDown: true }, { x: 625, y: 420, upsideDown: true }, // Шипи на стелі
        { x: 800, y: 420, upsideDown: true }, { x: 825, y: 420, upsideDown: true } // Шипи на стелі
    ]
...
let colors = {
    ...
    15: [
        { plat: 'teal', background: 'rgb(100, 200, 200)', ship: 'darkcyan' } // Бірюзовий стиль
    ],
    16: [
        { plat: 'indigo', background: 'rgb(150, 150, 255)', ship: 'darkblue' } // Синьо-фіолетовий стиль
    ],
    17: [
        { plat: 'crimson', background: 'rgb(255, 120, 120)', ship: 'darkred' } // Криваво-червоний стиль
    ]
};
